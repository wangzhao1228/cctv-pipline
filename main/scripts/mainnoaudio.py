...
if __name__ == "__main__":
    ...
    video_path = "D:/WorkDocument/10_项目/一供/项目汇报/0511/0511.mp4"
    ...
    output_path = 'D:/WorkDocument/10_项目/一供/项目汇报/0509/0511_tracked.mp4'
    ...
    # 缺陷信息处理
    video_width, video_height = 640, 480  # 示例分辨率，您可以根据视频元数据获取真实值
    ...
    summary_json_path = "D:/WorkDocument/10_项目/一供/项目汇报/0509/5月9日defect_summary.json"
    summary_data = {
    ...
    print(f"缺陷信息和评分已保存到：{summary_json_path}")
