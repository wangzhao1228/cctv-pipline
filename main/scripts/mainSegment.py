...
if __name__ == "__main__":
    ...
    # # model
    # model_GLFS_path = 'D:/workspaceTech/ultralytics/weights/obb/GLFS/best.pt'
    # model_QNCJ_path = 'D:/workspaceTech/ultralytics/weights/obb/QNCJ/best.pt'
    # model_ZGYW_path = 'D:/workspaceTech/ultralytics/weights/obb/ZGYW/best.pt'
    #
    # # output
    # output_GLFS_path = 'D:/WorkDocument/10_项目/一供/项目汇报/0509/5月9日_GLFS_tracked.mp4'
    # output_QNCJ_path = 'D:/WorkDocument/10_项目/一供/项目汇报/0509/5月9日_QNCJ_tracked.mp4'
    # output_ZGYW_path = 'D:/WorkDocument/10_项目/一供/项目汇报/0509/5月9日_ZGYW_tracked.mp4'
    #
    # GLFS_tracker = VideoTracker(video_path, model_GLFS_path, output_GLFS_path)
    # GLFS_tracker.track_video()
    # GLFS_frame_data = GLFS_tracker.get_all_frame_data()
    #
    # QNCJ_tracker = VideoTracker(video_path, model_QNCJ_path, output_QNCJ_path)
    # QNCJ_tracker.track_video()
    # QNCJ_frame_data = QNCJ_tracker.get_all_frame_data()
    #
    # ZGYW_tracker = VideoTracker(video_path, model_ZGYW_path, output_ZGYW_path)
    # ZGYW_tracker.track_video()
    # ZGYW_frame_data = ZGYW_tracker.get_all_frame_data()
    ...
    output_paths = ['D:/workspaceTech/ultralytics/main/res/0525/0525_GLFS_tracked.mp4',
                    'D:/workspaceTech/ultralytics/main/res/0525/0525_QNCJ_tracked.mp4',
                    'D:/workspaceTech/ultralytics/main/res/0525/0525_ZGYW_tracked.mp4']
    ...
    audio_json_path = "D:/workspaceTech/ultralytics/main/res/0525/0525audio_frequencies.json"
    analyzer.save_audio_frequencies_to_json(audio_json_path)
    output_filtered_json = "D:/workspaceTech/ultralytics/main/res/0525/0525audio_frequencies_filtered.json"
    ...
    Pipeline_json_path = "D:/workspaceTech/ultralytics/main/res/0525/0525pipeline_defect_summary.json"
    Pipeline_csv_path = "D:/workspaceTech/ultralytics/main/res/0525/0525pipeline_defect_summary.csv"
    evaluator = PipelineDefectEvaluator(defect_infos, total_length)  # 假设管道总长为1000米
    # evaluator.merge_defects(defect_infos)
    evaluator.save_evaluation_to_json(Pipeline_json_path)    evaluator.save_evaluation_to_csv(Pipeline_csv_path)
